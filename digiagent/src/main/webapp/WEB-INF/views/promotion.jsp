...
<!-- left menu end -->
	...
	<table id="tagContent" border="0" cellspacing="0" cellpadding="0" width="100%">
	  ...
	  <tr>
		<td valign="top" background="${ctx}/images/bg_pic00f.gif" style="padding-top:54px;"><img src="${ctx}/images/color_white.gif" width="10" height="72" /></td>
		<td bgcolor="#ffffff" valign="top">
		  <table border="0" cellspacing="0" cellpadding="0" align="center">
			...
			<tr>
			  ...
			  <td width="15"></td>
			  <td><input type="image" src="${ctx}/images/btn_seachgo.jpg" name="btnP" style="width:30px;height:30px;border-width: 0px"/></td>
			</tr>
			<tr>
