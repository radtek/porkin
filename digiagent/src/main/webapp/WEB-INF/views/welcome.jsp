...
<!-- left menu -->
	  <table border="0" cellspacing="0" cellpadding="0">
		  ...
		  <table border="0" cellspacing="0" cellpadding="0" width="190">
            ...
            <tr>
              <td bgcolor="#ffffff" class="text_left_on"><a onclick="selectTag('tagContent0',this)" href="javascript:void(0)">商讯导购</a></td>
            </tr>
            <tr>
	    ...
	    <tr>
		  ...
		  <table border="0" cellspacing="0" cellpadding="0" width="190">
			...
			<tr>
			  ...
			  <td bgcolor="#f8f8f8" rowspan="2" width="45"><img src="images/icon_left02.gif" /></td>
			  <td bgcolor="#f8f8f8" class="text_left_en">Goods Promotion</td>
			  <td background="images/bg_pic02g.gif" rowspan="2"></td>
			  <td rowspan="2"></td>
			</tr>
			<tr>
			  <td bgcolor="#f8f8f8" class="text_left"><a href="#" class="Aleft" onclick="selectTag('tagContent2',this)" href="javascript:void(0)">商品促销 <img src="images/btn_more.gif" /></a></td>
			</tr>
			<tr>
	    ...
	    <tr>
		  ...
		  <table border="0" cellspacing="0" cellpadding="0" width="190">
			...
			<tr>
			  <td bgcolor="#f8f8f8" class="text_left"><a href="#" class="Aleft" onclick="selectTag('tagContent3',this)" href="javascript:void(0)">二手信息<img src="images/btn_more.gif" /></a></td>
			</tr>
			<tr>
			  <td height="10"><img src="images/bg_pic02c.gif" /></td>
			  <td background="images/bg_pic02h.gif" colspan="2"></td>
