	  ...
	  <table border="0" cellspacing="0" cellpadding="0">
		  ...
		  <table border="0" cellspacing="0" cellpadding="0" width="190">
            ...
            <tr>
              ...
              <td bgcolor="#f8f8f8" rowspan="2" width="45"><img src="${ctx}/images/icon_left01.gif" /></td>
            ...
            <tr>
              <td bgcolor="#f8f8f8" class="text_left"><a href="${ctx}" class="Aleft">商讯导购 <img src="${ctx}/images/btn_more.gif" /></a></td>
            </tr>
            <tr>
	    ...
	    <tr>
		  ...
		  <tr>
			...
			<tr>
              ...
              <td bgcolor="#ffffff" rowspan="2" width="45"><img src="${ctx}/images/icon_left04.gif" /></td>
...
<!-- left menu end -->
	...
	<table id="tagContent" border="0" cellspacing="0" cellpadding="0" width="100%">
	  ...
	  <tr>
		<td valign="top" background="${ctx}/images/bg_pic00f.gif" style="padding-top:124px;"><img src="${ctx}/images/color_white.gif" width="10" height="72" /></td>
		<td bgcolor="#ffffff" valign="top">
		  <table border="0" cellspacing="0" cellpadding="0" align="center">
			...
			<tr>
			  ...
			  <td width="15"></td>
			  <td><input type="image" src="${ctx}/images/btn_seachgo.jpg" name="btnS" style="width:30px;height:30px;border-width: 0px"/></td>
			</tr>
			<tr>
