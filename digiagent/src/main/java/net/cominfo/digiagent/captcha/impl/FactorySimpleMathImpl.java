...
/**
 * Provide captchas in form of 1 + 2 1 - 2
 ** 
 * Simple Expression Parser Currently it only supports +- for simplicy who want
 * to solve 3+7*23 If users request the feature, I will add full blown
...
public class FactorySimpleMathImpl extends IWordFactory {
	...
	public String getWord() {
		...
		int maxDigit = Integer
				.valueOf(getProperties().getProperty("max", "10"));
		int numberOfSymbols = Integer.valueOf(getProperties().getProperty(
				"symbols", "3"));
