...
public class CountryService {
	...
	public List<Country> query(int pageNo, int pageSize,
		...
		page.setOrder("ASC");
		page.setParam(param);
		return (List<Country>) countryDao.findPage(page,
				"t_da_country_Custom.pageByCondition").getResult();
	}
	...
	public Country insert(Country country, String userName) {
		...
		if (country.getCountryId() != null) {
			...
			country.setCountryId(sequenceDao.getCountryNexId());
