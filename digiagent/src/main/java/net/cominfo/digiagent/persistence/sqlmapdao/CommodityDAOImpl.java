...
public class CommodityDAOImpl extends BaseDao implements CommodityDAO {
	...
	public List<Commodity> selectByExampleWithBLOBs(CommodityCriteria example) {
		List<Commodity> list = getSqlMapClientTemplate().queryForList(
				"t_da_commodity.ibatorgenerated_selectByExampleWithBLOBs",
				example);
		return list;
	}
	 ...
	 */
	@SuppressWarnings("unchecked")
	public List<Commodity> selectByExampleWithoutBLOBs(CommodityCriteria example) {
		List<Commodity> list = getSqlMapClientTemplate().queryForList(
	 ...
	 * @ibatorgenerated  Sat Aug 14 12:47:37 CST 2010
	 */
	public int updateByExampleWithBLOBs(Commodity record,
			CommodityCriteria example) {
		UpdateByExampleParms parms = new UpdateByExampleParms(record, example);
		int rows = getSqlMapClientTemplate().update(
				"t_da_commodity.ibatorgenerated_updateByExampleWithBLOBs",
				parms);
		return rows;
	}
	 ...
	 * @ibatorgenerated  Sat Aug 14 12:47:37 CST 2010
	 */
	public int updateByExampleWithoutBLOBs(Commodity record,
			CommodityCriteria example) {
		UpdateByExampleParms parms = new UpdateByExampleParms(record, example);
		int rows = getSqlMapClientTemplate().update(
	...
	public int updateByPrimaryKeyWithBLOBs(Commodity record) {
		int rows = getSqlMapClientTemplate().update(
				"t_da_commodity.ibatorgenerated_updateByPrimaryKeyWithBLOBs",
				record);
		return rows;
	}
	 ...
	 * @ibatorgenerated  Sat Aug 14 12:47:37 CST 2010
	 */
	public int updateByPrimaryKeyWithoutBLOBs(Commodity record) {
		int rows = getSqlMapClientTemplate().update(
