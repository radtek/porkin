...
public class SortableDAOImpl extends BaseDao implements SortableDAO {
	...
	public int countByExample(SortableCriteria example) {
		Integer count = (Integer) getSqlMapClientTemplate().queryForObject(
				"t_da_sortable.ibatorgenerated_countByExample", example);
		return count;
	}
	...
	public int deleteByExample(SortableCriteria example) {
		int rows = getSqlMapClientTemplate().delete(
				"t_da_sortable.ibatorgenerated_deleteByExample", example);
		return rows;
	}
	...
	public int deleteByPrimaryKey(Integer sortableId) {
		...
		int rows = getSqlMapClientTemplate().delete(
				"t_da_sortable.ibatorgenerated_deleteByPrimaryKey", key);
		return rows;
	}
	...
	public void insert(Sortable record) {
		getSqlMapClientTemplate().insert(
				"t_da_sortable.ibatorgenerated_insert", record);
	}
	...
	public void insertSelective(Sortable record) {
		getSqlMapClientTemplate().insert(
				"t_da_sortable.ibatorgenerated_insertSelective", record);
	}
	...
	public List<Sortable> selectByExample(SortableCriteria example) {
		List<Sortable> list = getSqlMapClientTemplate().queryForList(
				"t_da_sortable.ibatorgenerated_selectByExample", example);
		return list;
	}
	...
	public Sortable selectByPrimaryKey(Integer sortableId) {
		Sortable key = new Sortable();
		key.setSortableId(sortableId);
		Sortable record = (Sortable) getSqlMapClientTemplate().queryForObject(
				"t_da_sortable.ibatorgenerated_selectByPrimaryKey", key);
		return record;
	}
	 ...
	 * @ibatorgenerated  Sun Apr 10 20:46:03 CST 2011
	 */
	public int updateByExampleSelective(Sortable record,
			SortableCriteria example) {
		UpdateByExampleParms parms = new UpdateByExampleParms(record, example);
		int rows = getSqlMapClientTemplate()
				.update(
						"t_da_sortable.ibatorgenerated_updateByExampleSelective",
						parms);
		return rows;
	}
	...
	public int updateByExample(Sortable record, SortableCriteria example) {
		...
		int rows = getSqlMapClientTemplate().update(
				"t_da_sortable.ibatorgenerated_updateByExample", parms);
		return rows;
	}
	...
	public int updateByPrimaryKeySelective(Sortable record) {
		int rows = getSqlMapClientTemplate().update(
				"t_da_sortable.ibatorgenerated_updateByPrimaryKeySelective",
				record);
		return rows;
	}
	...
	public int updateByPrimaryKey(Sortable record) {
		int rows = getSqlMapClientTemplate().update(
				"t_da_sortable.ibatorgenerated_updateByPrimaryKey", record);
		return rows;
	}
