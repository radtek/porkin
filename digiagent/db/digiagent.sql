...
(
	-- 广告词表系统主键
	ADVERTISE_ID INT NOT NULL COMMENT '广告词表系统主键',
	-- 广告词内容
	ADVERTISE_DESCRIPTION VARCHAR(300) DEFAULT 'NA' NOT NULL COMMENT '广告词内容',
	-- 创建者
...
) ENGINE = InnoDB COMMENT = '广告词表' DEFAULT CHARACTER SET utf8;
...
(
	-- 品牌系统主键
	BRAND_ID INT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '品牌系统主键',
	-- 品牌中文名
	...
	-- 国家信息的系统主键
	COUNTRY_ID INT UNSIGNED NOT NULL COMMENT '国家信息的系统主键',
...
(
	-- 产品类别名系统主键
	CATEGORY_ID INT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '产品类别名系统主键',
	-- 产品类别中文名
...
(
	-- 城市系统主键
	CITY_ID INT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '城市系统主键',
	-- 城市中文名
	...
	-- 省份的系统主键
	PROVINCE_ID INT UNSIGNED NOT NULL COMMENT '省份的系统主键',
	PRIMARY KEY (CITY_ID)
...
(
	-- 商家评价的系统主键
	COMMENT_ID INT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '商家评价的系统主键',
	-- 评价等级
	COMMENT_RANK CHAR(1) NOT NULL COMMENT '评价等级',
	-- 评价内容
	COMMENT_CONTENT VARCHAR(3000) COMMENT '评价内容',
	-- 评价状态,N:无发票,Y:有发票
	COMMENT_STATUS CHAR(1) DEFAULT 'N' NOT NULL COMMENT '评价状态,N:无发票,Y:有发票',
	-- 创建者
	CREATED_BY VARCHAR(30) NOT NULL COMMENT '创建者',
	-- 创建时间
	CREATED_DATE DATETIME NOT NULL COMMENT '创建时间',
	...
	LASTUPDATED_DATE DATETIME NOT NULL COMMENT '最后更新时间',
	-- 供应商系统主键
	SUPPLIER_ID INT UNSIGNED NOT NULL COMMENT '供应商系统主键',
	-- 用户系统主键
	USER_ID INT UNSIGNED NOT NULL COMMENT '用户系统主键',
	PRIMARY KEY (COMMENT_ID)
) ENGINE = InnoDB COMMENT = '商家评价信息' DEFAULT CHARACTER SET utf8;
...
(
	-- 商品系统主键
	COMMODITY_ID INT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '商品系统主键',
	-- 商品名称
	...
	ACTIVE_FLAG CHAR(1) DEFAULT 'N' NOT NULL COMMENT '激活标志位',
	-- 产品
	PRODUCT_ID INT UNSIGNED DEFAULT 1 NOT NULL COMMENT '产品',
	-- 促销页面原价
	COMMODITY_PRICE_OLD FLOAT(10,2) UNSIGNED DEFAULT 0 COMMENT '促销页面原价',
...
(
	-- 商品图像系统主键
	COMMODITYIMAGE_ID INT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '商品图像系统主键',
	-- 商品图像内容
	...
	ACTIVE_FLAG CHAR(1) COMMENT '激活标志位',
	-- 商品系统主键
	COMMODITY_ID INT UNSIGNED NOT NULL COMMENT '商品系统主键',
...
(
	-- 联系方法系统主键
	CONTACT_ID INT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '联系方法系统主键',
	-- 联系方式内容
...
(
	-- 国家信息的系统主键
	COUNTRY_ID INT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '国家信息的系统主键',
	-- 国家中文名
...
(
	-- 访问历史系统主键
	HISTORY_ID INT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '访问历史系统主键',
	-- 访问内容类型(B:品牌,C:大类,P:产品,E:品牌产品,S:供应商)
	HISTORY_TYPE CHAR(1) NOT NULL COMMENT '访问内容类型(B:品牌,C:大类,P:产品,E:品牌产品,S:供应商)',
	-- 所对应的ID,如产品ID,供应商ID
	HISTORY_TYPEID INT UNSIGNED NOT NULL COMMENT '所对应的ID,如产品ID,供应商ID',
	-- 访问时间
	HISTORY_ACCESSDATE DATETIME NOT NULL COMMENT '访问时间',
	HISTORY_FROMIP VARCHAR(128) DEFAULT '255.255.255.255' NOT NULL,
...
(
	-- 产品系统主键
	PRODUCT_ID INT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '产品系统主键',
	-- 产品中文名
	...
	ACTIVE_FLAG CHAR(1) DEFAULT 'N' NOT NULL COMMENT '激活标志位',
	-- 产品类别名系统主键
	CATEGORY_ID INT UNSIGNED NOT NULL COMMENT '产品类别名系统主键',
	-- 显示的类别，1:导购, 2:二手, 3:导购+二手, 4:促销, 5:导购+促销, 6:二手+:促销, 7:导购+二手+促销
	DISPLAY_TYPE CHAR(1) DEFAULT '1' NOT NULL COMMENT '显示的类别，1:导购, 2:二手, 3:导购+二手, 4:促销, 5:导购+促销, 6:二手+:促销, 7:导购+二手+促销',
...
(
	-- 品牌产品系统主键
	PRODUCTBRAND_ID INT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '品牌产品系统主键',
	-- 品牌系统主键
	BRAND_ID INT UNSIGNED NOT NULL COMMENT '品牌系统主键',
	-- 产品系统主键
	PRODUCT_ID INT UNSIGNED NOT NULL COMMENT '产品系统主键',
	-- 创建者
	CREATED_BY VARCHAR(30) COMMENT '创建者',
	-- 创建时间
	CREATED_DATE DATETIME COMMENT '创建时间',
...
(
	-- 省份的系统主键
	PROVINCE_ID INT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '省份的系统主键',
	-- 省份的中文名称；如辽宁省等
...
(
	-- 角色系统主键
	ROLE_ID INT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '角色系统主键',
	-- 角色名称
...
(
	...
	-- 系统主键值
	NEXTID INT UNSIGNED NOT NULL COMMENT '系统主键值',
	PRIMARY KEY (NAME)
...
(
	-- 供应商系统主键
	SUPPLIER_ID INT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '供应商系统主键',
	-- 供应商名称
	...
	SUPPLIER_ACCESS INT UNSIGNED DEFAULT 0 NOT NULL,
	SUPPLIER_SCORE INT UNSIGNED DEFAULT 0 NOT NULL,
	-- 城市系统主键
	CITY_ID INT UNSIGNED NOT NULL COMMENT '城市系统主键',
	-- 用户系统主键
	USER_ID INT UNSIGNED NOT NULL COMMENT '用户系统主键',
	-- 创建者
	CREATED_BY VARCHAR(30) NOT NULL COMMENT '创建者',
	...
	ACTIVE_FLAG CHAR(1) NOT NULL COMMENT '激活标志位',
	-- 供应商官方网站
	SUPPLIER_WEBSITE VARCHAR(300) COMMENT '供应商官方网站',
...
(
	...
	SUPPLIER_ID INT UNSIGNED NOT NULL COMMENT '供应商系统主键',
	-- 品牌产品系统主键
	PRODUCTBRAND_ID INT UNSIGNED NOT NULL COMMENT '品牌产品系统主键',
	-- 供应商产品代理开始时间
	CREATE_DATE DATE COMMENT '供应商产品代理开始时间',
	-- 供应商产品代理开始时间
	START_DATE DATE COMMENT '供应商产品代理开始时间',
	-- 供应商产品代理结束时间
	END_DATE DATE COMMENT '供应商产品代理结束时间',
...
(
	-- 用户系统主键
	USER_ID INT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '用户系统主键',
	-- 用户名
	...
	-- 登录次数
	LOGONSUM INT UNSIGNED NOT NULL COMMENT '登录次数',
	-- 创建者
	CREATED_BY VARCHAR(30) NOT NULL COMMENT '创建者',
	-- 创建时间
	CREATED_DATE DATETIME NOT NULL COMMENT '创建时间',
...
(
	...
	USER_ID INT UNSIGNED NOT NULL COMMENT '用户系统主键',
	-- 角色系统主键
	ROLE_ID INT UNSIGNED NOT NULL COMMENT '角色系统主键'
