...
<form action="${ctx}/password">
  <table width="60%" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
      <td>输入帐号</td>
      <td><input type="text" name="username" id="username" /><font color="red"><c:if test="${not empty username}"><fmt:message key="${username.text}" /></c:if></td>
    </tr>
    <tr>
      <td>验证码显示</td>
    ...
    <tr>
      <td>随机验证</td>
      <td><input type="text" name="captcha" id="captcha" /><font color="red"><c:if test="${not empty captcha}"><fmt:message key="${captcha.text}" /></c:if></td>
    </tr>
    <tr>
    	<td></td>
    </tr>
