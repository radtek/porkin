  ...
  <div id="tagContent" >
    ...
    <form action="freeSearch" method="post">
      <table border="0" cellpadding="0" cellspacing="0" align="center">
        ...
        <tr>
        	<td colspan="3">&nbsp;<input type="hidden" name="categoryId" value="${categoryId}"/><input type="hidden" name="productId" value="${productId}"/><input type="hidden" name="productBrandId" value="${productBrandId}"/></td>
        </tr>
        <tr>
